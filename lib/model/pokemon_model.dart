...
class Pokemon {
    ...
    factory Pokemon.fromJson(Map<String, dynamic> json) => Pokemon(
        ...
        weaknesses: json["weaknesses"] == null ? [] : List<Type>.from(json["weaknesses"]!.map((x) => typeValues.map[x]!)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "weaknesses": weaknesses == null ? [] : List<dynamic>.from(weaknesses!.map((x) => typeValues.reverse[x])),
